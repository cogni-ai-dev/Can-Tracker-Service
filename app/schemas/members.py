...
class MemberCreate(BaseModel):
    ...
    can_number: str = Field(min_length=1, max_length=64)
    ...
    @classmethod
    def validate_can_number(cls, value: str) -> str:
        return normalize_can_number(value)
...
class MemberUpdate(BaseModel):
    ...
    can_number: str | None = Field(default=None, min_length=1, max_length=64)
    pan: str | None = Field(default=None, max_length=32)
    date_of_birth: date | None = None
    ...
    def validate_can_number(cls, value: str | None) -> str | None:
        return None if value is None else normalize_can_number(value)
