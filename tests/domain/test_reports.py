...
class ReportFilterTests(unittest.TestCase):
    def setUp(self) -> None:
        self.members = [
            active_member("valid"),
            active_member("registered", kyc_status="Registered"),
            active_member("no-kyc", kyc_status="No KYC"),
            active_member("sent", payeezz_status="Sent for Approval"),
            active_member("not-available", payeezz_status="Not Available"),
            active_member("mobile", mobile_status="Not Verified"),
            active_member("email", email_status="Not Verified"),
            active_member("nominee", nominee_status="Not Verified"),
            active_member(
                "deleted",
                kyc_status="No KYC",
